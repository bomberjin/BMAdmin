...
!function ($) {
	...
	function transitionEnd() {
		var el = document.createElement('bootstraptable');
...
! (function(factory) {
	...
	Datetimepicker.prototype = {
		...
		prevMonth.setUTCDate(prevMonth.getDate() - (prevMonth.getUTCDay() - this.weekStart + 7)%7);*/
			...
			if (currentYear == year) {
				...
				// To cater bootstraptable 2 we don't need to select the next one
	...
	jquery 1.7.1 + webkit + show inline datetimepicker in bootstraptable popover.
